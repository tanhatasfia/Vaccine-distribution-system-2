            ...
            <div class="row">
                ...
                <?php
                    ...
                    if(isset($_POST['submit'])){
                      ...
                      if ($result) {
                                  echo "<h1>HAPPY VACCINTION!</h1>";
                                  $ss = "update hospital_vaccine
                                  set Total_Distributed=Total_Distributed+1
                                  where Vaccine_id=(select vaccine_id from vaccine where vaccine_name='". $vaccine_name ."') and
                                   Hospital_id=(select hospital_id from hospital where Hospital_name='". $hospital_name ."')";
