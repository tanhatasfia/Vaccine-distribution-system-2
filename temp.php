            ...
            <div class="row">
                ...
                <?php
                    ...
                    if(isset($_POST['submit'])){
                      ...
                      $s3 = oci_parse($conn, $s = oci_parse($conn, "select sum(FT-ST)
                      from (select F_Total_Dosages FT from Foreign_Hospital_Vaccine FHV inner join Vaccine V on FHV.Vaccine_id=V.Vaccine_id 
                      where vaccine_name='".$vaccine."' and v.vaccine_id in('V00000000005')) NATURAL JOIN
                      ...
                      where vaccine_name='".$vaccine."' and
                       v.vaccine_id in('V00000000005'))"));       
                      oci_execute($s3);
